...
const (
	PinInput       = 0 // Input mode
	PinOutput10MHz = 1 // Output mode, max speed 10MHz
	PinOutput2MHz  = 2 // Output mode, max speed 2MHz
	PinOutput50MHz = 3 // Output mode, max speed 50MHz
	PinOutput      = PinOutput2MHz

	PinInputModeAnalog     = 0  // Input analog mode
	PinInputModeFloating   = 4  // Input floating mode
	PinInputModePullUpDown = 8  // Input pull up/down mode
	PinInputModeReserved   = 12 // Input mode (reserved)

	PinOutputModeGPPushPull   = 0  // Output mode general purpose push/pull
	PinOutputModeGPOpenDrain  = 4  // Output mode general purpose open drain
	PinOutputModeAltPushPull  = 8  // Output mode alt. purpose push/pull
	PinOutputModeAltOpenDrain = 12 // Output mode alt. purpose open drain
)
